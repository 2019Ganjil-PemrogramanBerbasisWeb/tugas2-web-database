    ...
    <div class="container"><a class="navbar-brand">e-KOSPIN</a>
        ...
        <div id="my-nav" class="collapse navbar-collapse">
            ...
            <form class="form-inline my-2 my-lg-0">
                ...
                <a href="sign_up.php" class="btn btn-info my-2 my-sm-0">Sign Up</a>
            </form>
        </div>
    </div>
</nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="contact.php">Contact Us <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
            <div class="col-md-6">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a href="sign_up.php">Learn More <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                ...
                <a href="sign_up.php">All Services <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
            <div class="col-lg-8">
                <svg id="bg-services"
                     width="100%"
                ...
                <div class="card text-center"><img class="card-img-top" src="images/news1.jpg" alt="">
                    <div class="card-body text-left pr-0 pl-0">
                        ...
                        <p class="card-text">Donec non sem mi. In hac habitasse platea dictumst. Nullam a feugiat augue,
                            ...
                            . . . </p>
                        <a href="sign_up.php">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                </div>
            </div>
            <div>
                ...
                <div class="card text-center"><img class="card-img-top" src="images/news2.jpg" alt="">
                    <div class="card-body text-left pr-0 pl-0">
                        ...
                        <p class="card-text">Donec non sem mi. In hac habitasse platea dictumst. Nullam a feugiat augue,
                            et porta metus. Nulla mollis lobortis leet. Maecenas tincidunt, arcu sed ornare purus risus
                            . . . </p>
                        <a href="sign_up.php"></a>READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                </div>
            </div>
            <div>
                <div class="card text-center"><img class="card-img-top" src="images/news3.jpg" alt="">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <ul class="nav flex-column company-nav">
                            <li class="nav-item"><a class="nav-link" href="index.php">Home</a></li>
                            <li class="nav-item"><a class="nav-link" href="sign_in.php">Services</a></li>
                            <li class="nav-item"><a class="nav-link" href="sign_in.php">About</a></li>
                            <li class="nav-item"><a class="nav-link" href="sign_in.php">News</a></li>
