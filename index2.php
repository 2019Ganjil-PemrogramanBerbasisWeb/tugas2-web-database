    ...
    <div class="container"><a class="navbar-brand">e-KOSPIN</a>
        ...
        <div id="my-nav" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="contact_s.html">Contact</a></li>
            </ul>
            <form class="form-inline my-2 my-lg-0">
                <a href="index.html" class="btn btn-outline-dark my-2 my-sm-0 mr-3">Sign Out</a> 
            </form>            
        </div>
    </div>
</nav>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a href="about.html">Learn More <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                ...
                <a href="services.html">All Services <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
            <div class="col-lg-8">
                <svg id="bg-services"
                     width="100%"
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6" id="contact">
                <h4> Contact Us </h4>
                <a href="contact.html" class="submit-button">Click! <i class="fa fa-angle-right" aria-hidden="true"></i></a>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-6">
