                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form" action="insert.php">
                            ...
                            <div class="form-group">
                                ...
                                <label for="agree-term" class="label-agree-term"><span><span></span></span>I agree all statements in  <a href="term.html" target="_blank" class="term-service">Terms of service</a></label>
                            </div>
